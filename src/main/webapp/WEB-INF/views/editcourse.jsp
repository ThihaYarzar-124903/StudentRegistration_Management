	...
	<div class="sidebar">
		...
		<div class="second">	
    		...
    		<div class="col-md-4"></div>
   			<div class="col-md-4 ">
      		<form:form class="mt-5 bg-white p-4 rounded shadow" action="/StudentRegistration/courses/edit" method="post" modelAttribute="course">
        		...
        		<div class="mb-3">
					<form:input type="hidden" path="course_code" />
				</div>
