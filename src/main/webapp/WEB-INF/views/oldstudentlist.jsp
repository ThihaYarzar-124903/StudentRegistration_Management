						...
						<tr>
							...
							<td>
								<div class="col">
									...
									<button class="delete-btn btn btn-success" data-student-id="${student.id}">Resend</button>
								</div>
							</td>
	...
	<script>
        ...
        $(document).ready(function () {
            ...
            $('.delete-btn').click(function () {
                ...
                $.ajax({
                    url: '/StudentRegistration/students/callback/' + studentId,
                    type: 'DELETE',
