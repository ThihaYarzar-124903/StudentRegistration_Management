		...
		<div class="row">
			...
			<div class="col-md-4" style="padding-top:120px; color:#272829;">
				<div style="text-align: center; background-color: #FFF6E0; border:2px solid #272829;">
					...
					<form:form action="/StudentRegistration/otpprogress" method="post" modelAttribute="obean" style="color:black;">

						<label style="color:#272829;">Your OTP</label>
						
						<br>
						<form:input type="text"  path="otp" style="width:90%; border:2px solid #272829;"/>
						<br>
						<br>
